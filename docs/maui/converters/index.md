...
| [`ColorToPercentKeyConverter`](color-to-percent-key-converter.md) | The `ColorToPercentKeyConverter` is a one way converter that allows users to convert an incoming `Color` to the **key** component as a value between 0 and 1. |
