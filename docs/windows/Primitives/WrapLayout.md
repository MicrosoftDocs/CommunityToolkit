...
:::code language="xaml" source="~/../code-windows/components/Primitives/samples/WrapLayoutSample.xaml":::

:::code language="csharp" source="~/../code-windows/components/Primitives/samples/WrapLayoutSample.xaml.cs":::
